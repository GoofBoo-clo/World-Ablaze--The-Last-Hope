	NDefines.NGame.START_DATE = "2030.1.1.1";
	...
	-- Удалятор лагов 3000, Взято из Spot Optimiser
	
    NDefines.NGame.COMBAT_LOG_MAX_MONTHS = 3 --12
    NDefines.NGame.MESSAGE_TIMEOUT_DAYS = 8					     	 -- WAS 60 	| less messages lying around at the top of your screen
    NDefines.NGame.LAG_DAYS_FOR_LOWER_SPEED = 125 --10
    NDefines.NGame.LAG_DAYS_FOR_PAUSE = 150 --25
    NDefines.NGame.GAME_SPEED_SECONDS = { 0.5, 0.30, 0.15, 0.05, 0.0 } --{2.0, 0.5, 0.2, 0.1, 0.0}						-- Data storring data
	...
	-- Battleplan AI
	NDefines.NAI.PLAN_ACTIVATION_SUPERIORITY_AGGRO = 2.0     					-- Vanilla is 1.0 HYPER AGGRESSIVE AI
